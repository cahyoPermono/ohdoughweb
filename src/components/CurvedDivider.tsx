export default function CurvedDivider({ color = "#ffffff", type = "bottom" }: { color?: string; type?: "top" | "bottom" }) {
    if (type === "top") {
      return (
        <div style={{ position: "absolute", top: 0, left: 0, width: "100%", overflow: "hidden", lineHeight: 0, transform: "rotate(180deg)" }}>
          <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" style={{ position: "relative", display: "block", width: "calc(138% + 1.3px)", height: "60px" }}>
